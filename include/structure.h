...
arbre ajoute_noeud_arbre(arbre a, int **plateau, liste possible);

arbre creer_arbre_position(int x, int y);//recursive creer un arbre de possibilitées à partir d'un coup jouer par l'IA
